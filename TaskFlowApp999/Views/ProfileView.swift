...
struct ProfileView: View {
    ...
    @State private var showingBiometricSettings = false // Added Face ID settings
     ...
     private var menuOptionsSection: some View {
         VStack(alignment: .leading, spacing: 16) {
             ...
             VStack(spacing: 0) {
                 ...
                 // Face ID/Biometric Settings Menu Item
                 MenuOptionRow(
                     icon: "faceid",
                     title: "Biometric Settings",
                     subtitle: "Configure Face ID and Touch ID",
                     iconColor: .blue
                 ) {
                     print("🔒 Biometric settings tapped - User: gamikapunsisi at 2025-08-20 16:40:15")
